Locales['fr'] = {
  ...
  ['command_setorg'] = 'assigner org à un joueur',
  ['command_setorg_org'] = 'nom du org',
  ['command_setorg_grade'] = 'grade du org',
  ['command_setorg_invalid'] = 'le org, le grade ou les deux sont invalides',
